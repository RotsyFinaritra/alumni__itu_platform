                ...
                <div id="menu-body">
                    <li>
                        ...
                        <ul class="   ">
                            ...
                            <li><a href="<%=lien%>?but=recette/recette-recapitulatif.jsp" class="menu-niveau-2">Etat récapitulatif des recettes</a></li>
                        ...
                        <ul class="   ">
                            ...
                            <li><a href="#" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Statistiques Amendes</a></li>
                            <li><a href="#" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Statistiques Permis de conduire</a></li>
                        </ul>
                    </li>
                </div>
