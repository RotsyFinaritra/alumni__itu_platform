            ...
            <div class="sidebar-menu" id="menuslider" style="background-color:rgb(249, 249, 249); color:black; ">
                <div id="menu-body">
                    <li>
                        ...
                        <ul class="">
                            <li><a href="<%=lien%>?but=amende/amende-liste.jsp" class="menu-niveau-2">Liste amende</a></li>
                            <li><a href="<%=lien%>?but=amende/amende-saisie.jsp" class="menu-niveau-2">Saisie amende</a></li>
                            <li><a href="<%=lien%>?but=amende/amende_analyse.jsp" class="menu-niveau-2">Decompte des droits des avantages verbalisateurs</a></li>
