...
%=MenuDynamique.renderMenu(arbre, currentMenu, tabMenu)%>              
            ...
            <div class="sidebar-menu" id="menuslider" style="background-color:rgb(249, 249, 249); color:black; ">
                <div id="menu-body">
                    <li>
                        <a href="#" class="menu-niveau-1"><i class="fa fa-folder-open"></i>Gestion de stock</a>
                        <ul class="   ">
                            <li><a href="<%=lien%>?but=stock/article/article-liste.jsp" class="menu-niveau-2">Article</a></li>
                            <li><a href="<%=lien%>?but=stock/bc/stBonDeCommande-liste.jsp" class="menu-niveau-2">Bon de commande</a></li>
                            <li><a href="<%=lien%>?but=stock/bl/bondelivraison-liste.jsp&typeEtat=sortie" class="menu-niveau-2">Bon de livraison</a></li>
                            <li><a href="<%=lien%>?but=stock/inventaire/inventaire-liste.jsp" class="menu-niveau-2">Inventaire</a></li>
                            <li><a href="<%=lien%>?but=stock/mvtStock/intraMvtStock-liste.jsp" class="menu-niveau-2">Transfert</a></li>
                            <li><a href="<%=lien%>?but=stock/mvtStock/mvtStock-liste.jsp&typeEtat=sortie" class="menu-niveau-2">Mouvement de stock</a></li>
                            <li><a href="<%=lien%>?but=stock/mvtStock/mvtStock-entree.jsp" class="menu-niveau-2">Entree en stock</a></li>
                            <li><a href="<%=lien%>?but=stock/mvtStock/mvtStock-sortie.jsp" class="menu-niveau-2">Sortie en stock</a></li>
                            <li><a href="<%=lien%>?but=stock/mvtStock/mvtStock-etat.jsp&typeEtat=sortie" class="menu-niveau-2">Etat de stock</a></li>
                            <li><a href="<%=lien%>?but=stock/analyse-stock.jsp" class="menu-niveau-2">Analyse stock</a></li>
                            <li><a href="<%=lien%>?but=facturegallois/tiers/tiersfournisseur-liste.jsp&typetiers=fournisseur" class="menu-niveau-2">Fournisseurs</a></li>
                        </ul>
                    </li>
                </div>
