            ...
            <div class="sidebar-menu" id="menuslider" style="background-color:rgb(249, 249, 249); color:black; ">
                <div id="menu-body">
                    <li>
                        ...
                        <a href="#" class="menu-niveau-1"><i class="fa fa-folder-open"></i>Statistiques</a>
                        <ul class="   ">
                            <li><a href="<%=lien%>?but=acte/analyse-demande.jsp" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Statistiques Licences</a></li>
                            <li><a href="#" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Statistiques Autorisations speciales</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="   ">
                            <li>
                                ...
                                <ul class="">
                                    ...
                                    <li><a href="<%=lien%>?but=acte/nouvelledemande.jsp" class="menu-niveau-3">Saisie Nouvelle licence</a></li>
                                    <li><a href="<%=lien%>?but=acte/renouvellement-demande.jsp" class="menu-niveau-3">Saisie Renouvellement licence</a></li>
                                    <li><a href="<%=lien%>?but=acte/liquidation-licence.jsp&saisie=acte/nouvelle-demande.jsp&idtype_demandelicence=Licence" class="menu-niveau-3">Liquidation licence</a></li>
                            ...
                            <li>
                                ...
                                <ul class="">
                                    <li><a href="<%=lien%>?but=acte/demande-licence-liste.jsp&saisie=acte/autorisation.jsp&idtype_demandelicence=Autorisation%25" class="menu-niveau-3">Liste Autorisation speciale</a></li>
                                    <li><a href="<%=lien%>?but=acte/autorisation.jsp" class="menu-niveau-3">Saisie Autorisation speciale</a></li>
                                    <li><a href="<%=lien%>?but=acte/liquidation-licence.jsp&saisie=acte/autorisation.jsp&idtype_demandelicence=Autorisation%20speciale" class="menu-niveau-3">Liquidation Autorisation speciale</a></li>
