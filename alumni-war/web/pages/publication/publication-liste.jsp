<%@ page import="bean.*, utilitaire.Utilitaire, java.util.*" %>
...
<% try {
    ...
    apresWhere.append(" ORDER BY created_at DESC LIMIT ").append(postsPerPage)
               .append(" OFFSET ").append((page - 1) * postsPerPage);
                ...
                <div class="box <%= boxClass %>">
                    ...
                    <div class="box-body">
                        ...
                        <div class="well well-sm" style="margin-top: 15px;">
                            ...
                            <i class="fa fa-calendar"></i> <%= Utilitaire.formatterDaty(activite.getDate_debut()) %>
