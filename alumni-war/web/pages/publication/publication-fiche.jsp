                    ...
                    <div class="box-body">
                        ...
                        <div class="well" style="margin-top: 20px;">
                            ...
                            <table class="table table-striped" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    <th>Date de début</th>
                                    <td><i class="fa fa-calendar"></i> <%= sdf.format(activite.getDate_debut()) %></td>
                                </tr>
                                <% } %>
                                <% if (activite.getDate_fin() != null) { %>
                                <tr>
                                    <th>Date de fin</th>
                                    <td><i class="fa fa-calendar"></i> <%= sdf.format(activite.getDate_fin()) %></td>
                                </tr>
                                <% } %>
                    ...
                    <div class="box-body">
                        ...
                        <% } else {
                            for (Object o : commentaires) {
                                ...
                                String commentDate = sdf.format(comment.getCreated_at());
            ...
            <div class="col-md-4">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <p class="text-muted"><%= sdf.format(post.getUpdated_at()) %></p>
                        <% } %>
                    </div>
                </div>
