...
<% try{
    ...
    t.setNomTable("donationlibcpl");
    String listeCrt[] = {"id", "daty","nom","desce" ,"idEntiteDonateurLib", "idcategoriedonateurlib","idcategorielib", "idprojetlib", "idRecepteurLib"};
    ...
    pr.setTitre("Liste des dons - Entreprise");
    pr.setUtilisateur((user.UserEJB) session.getValue("u"));
    pr.setLien((String) session.getValue("lien"));
    pr.setApres("donation/donation-liste-alls.jsp");
    ...
    pr.getFormu().getChamp("idRecepteurLib").setLibelle("Recepteur");
    pr.setNpp(50);
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div style="font-size:13px; font-style:italic; color:#555;">
            **Les prix des mat&eacute;riaux ont &eacute;t&eacute; estim&eacute;s selon les prix locaux.
        </div>
        <%
