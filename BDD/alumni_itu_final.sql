...
\restrict HzXUdTTdtwMzyS1ohJNswn1cmo9FqimZGPBGXwlynIIh34XYa2SncAYTcET93A9
...
--
-- Name: v_competence_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_competence_aff AS
 SELECT id,
    libelle,
    (((id)::text || ' - '::text) || (libelle)::text) AS aff
   FROM public.competence;


ALTER VIEW public.v_competence_aff OWNER TO postgres;

--
-- Name: v_entreprise_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_entreprise_aff AS
 SELECT id,
    libelle,
    idville,
    description,
...
ALTER VIEW public.v_entreprise_aff OWNER TO postgres;
...
--
-- Name: v_pays_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_pays_aff AS
 SELECT id,
    libelle,
    (((id)::text || ' - '::text) || (libelle)::text) AS aff
   FROM public.pays;
...
ALTER VIEW public.v_pays_aff OWNER TO postgres;
...
--
-- Name: v_promotion_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_promotion_aff AS
 SELECT id,
    libelle,
    annee,
    id_option,
...
ALTER VIEW public.v_promotion_aff OWNER TO postgres;
...
--
-- Name: v_type_utilisateur_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_type_utilisateur_aff AS
 SELECT id,
    libelle,
    (((id)::text || ' - '::text) || (libelle)::text) AS aff
...
ALTER VIEW public.v_type_utilisateur_aff OWNER TO postgres;
...
--
-- Name: v_ville_aff; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_ville_aff AS
 SELECT id,
    libelle,
    idpays,
    (((id)::text || ' - '::text) || (libelle)::text) AS aff
...
ALTER VIEW public.v_ville_aff OWNER TO postgres;
...
COM100001	209	POST100001	\N	Super intéressant ! Moi je suis encore sur Python/Django mais Rust me tente aussi.	0	2026-02-10 09:15:00	\N
COM100002	211	POST100001	COM100001	Django c'est très bien pour le prototypage rapide. Rust c'est mieux pour la performance.	0	2026-02-10 10:00:00	\N
COM100003	204	POST100002	\N	J'ai fait un bootcamp chez DataCamp, c'était vraiment top. Je te recommande.	0	2026-02-10 15:30:00	\N
COM100004	211	POST100003	\N	Moi j'ai envoyé à Orange et BNI, toujours en attente de réponse.	0	2026-02-11 10:00:00	\N
COM100005	212	POST100003	\N	Essaye aussi les startups, elles recrutent beaucoup de stagiaires en ce moment.	0	2026-02-11 11:30:00	\N
COM100006	214	POST100003	COM100004	Orange recrute pas mal en ce moment, tu devrais avoir une réponse bientôt.	0	2026-02-11 12:15:00	\N
COM100007	213	POST100004	\N	Trop bien ! On cherche un 3ème membre pour notre équipe, quelqu'un intéressé ?	0	2026-02-12 08:30:00	\N
COM100008	215	POST100004	COM100007	Je suis partant ! Envoie-moi un message.	0	2026-02-12 09:00:00	\N
COM100009	202	POST100005	\N	Félicitations ! Quels sont les plus gros défis quand on lance sa boîte à Madagascar ?	0	2026-02-13 11:00:00	\N
COM100010	205	POST100005	COM100009	Merci ! Le plus dur c'est l'accès au financement et la confiance des clients locaux.	0	2026-02-13 11:45:00	\N
COM100011	206	POST100005	\N	Bravo Solo ! Tu embauches des juniors bientôt ?	0	2026-02-13 12:30:00	\N
COM100012	205	POST100005	COM100011	Oui on prévoit de recruter 2 juniors au Q2. Restez connectés !	0	2026-02-13 13:00:00	\N
COM100013	213	POST100006	\N	Pareil pour moi... Le planning de révision ça aide beaucoup.	0	2026-02-14 17:00:00	\N
COM100014	216	POST100006	\N	Courage ! N'hésite pas à demander de l'aide aux profs.	0	2026-02-14 18:00:00	\N
COM100015	209	POST100014	\N	C'est exactement mon stack ! Comment postuler ?	0	2026-02-14 12:00:00	\N
COM100016	211	POST100014	\N	Le télétravail est possible à 100% ou partiel ?	0	2026-02-14 13:30:00	\N
COM100017	205	POST100014	COM100015	Envoie ton CV à jobs@cybersec.mg avec ta lettre de motivation !	0	2026-02-14 14:00:00	\N
COM100018	201	POST100010	\N	Excellente idée ! Je propose qu'on fixe le premier pour mi-mars.	0	2026-02-18 14:00:00	\N
COM100019	203	POST100010	\N	Je suis dispo ! On pourrait commencer par un talk sur le DevOps.	0	2026-02-18 14:30:00	\N
COM100020	207	POST100010	COM100018	Mi-mars ça me va. Un samedi matin ce serait parfait pour tout le monde.	0	2026-02-18 15:00:00	\N
COM100021	208	POST100010	\N	Super initiative, comptez sur moi !	0	2026-02-18 16:00:00	\N
COM100022	204	POST100010	COM100019	Un talk DevOps + un atelier pratique Docker ce serait top.	0	2026-02-18 17:00:00	\N
COM100023	209	POST100030	\N	On s'inscrit avec mon équipe ! C'est le thème parfait pour nous.	0	2026-02-14 09:00:00	\N
COM100024	213	POST100030	\N	Trop hâte ! On a déjà une idée de projet.	0	2026-02-14 10:00:00	\N
COM100025	210	POST100030	\N	Est-ce que les équipes mixtes étudiants-alumni sont autorisées ?	0	2026-02-14 11:00:00	\N
COM100026	206	POST100030	COM100025	Oui, les équipes mixtes sont encouragées ! Max 5 personnes par équipe.	0	2026-02-14 11:30:00	\N
COM100027	215	POST100030	\N	Je cherche une équipe, quelqu'un veut bien de moi ?	0	2026-02-14 12:00:00	\N
COM100028	214	POST100030	COM100027	Viens avec nous ! On est 3 pour l'instant.	0	2026-02-14 12:30:00	\N
COM100029	209	POST100036	\N	Projet très utile ! C'est quel langage/framework ?	0	2026-02-15 11:00:00	\N
COM100030	211	POST100036	COM100029	On utilise React + Express + PostgreSQL. Le repo est sur GitHub.	0	2026-02-15 11:30:00	\N
COM100031	207	POST100036	\N	Je voudrais contribuer à la partie UX. Comment rejoindre ?	0	2026-02-15 12:00:00	\N
\.
...
EX0002877281	2026-02-27	00:26:16:103	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877301	2026-02-27	00:32:50:171	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877321	2026-02-27	00:37:33:805	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877341	2026-02-27	00:44:55:945	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877361	2026-02-27	00:51:24:980	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877381	2026-02-27	01:51:46:73	bean.Post	Insertion par 122	122	POST000019
EX0002877401	2026-02-27	01:51:46:77	bean.PostEmploi	Insertion par 122	122	POST000019
EX0002877421	2026-02-27	01:28:33:796	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877441	2026-02-27	01:30:56:695	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877461	2026-02-27	01:41:39:766	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877481	2026-02-27	01:43:04:604	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877501	2026-02-27	01:43:29:397	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877521	2026-02-27	01:49:01:573	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877541	2026-02-27	01:55:35:966	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877561	2026-02-27	02:19:46:977	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877581	2026-02-27	02:24:52:684	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877601	2026-02-27	02:46:27:323	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877621	2026-02-27	02:53:05:783	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877641	2026-02-27	03:04:49:166	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877661	2026-02-27	03:14:06:650	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877681	2026-02-27	04:16:51:89	bean.Post	Insertion par 1	1	POST000020
EX0002877701	2026-02-27	04:16:51:93	bean.PostStage	Insertion par 1	1	POST000020
EX0002877721	2026-02-27	13:46:22:070	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877741	2026-02-27	14:49:21:77	bean.Notification	Modification par 1	1	NOTIF000002
EX0002877761	2026-02-27	14:49:21:79	bean.Notification	Modification par 1	1	NOTIF000003
EX0002877781	2026-02-27	14:49:27:52	bean.Notification	Modification par 1	1	NOTIF000001
EX0002877801	2026-02-27	13:50:39:395	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877821	2026-02-27	13:58:06:964	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877841	2026-02-27	14:15:07:248	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877861	2026-02-27	15:23:22:91	bean.Post	Insertion par 1	1	POST000021
EX0002877881	2026-02-27	15:23:22:95	bean.PostActivite	Insertion par 1	1	POST000021
EX0002877901	2026-02-27	15:23:22:97	bean.PostFichier	Insertion par 1	1	PFIC000008
EX0002877921	2026-02-27	14:24:55:988	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002877941	2026-02-27	14:34:07:165	mg.cnaps.utilisateur.CNAPSUser	login	122	122
EX0002877961	2026-02-27	14:35:08:798	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878021	2026-02-27	14:42:11:408	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878061	2026-02-27	14:55:58:747	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878081	2026-02-27	14:58:21:108	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878101	2026-02-27	15:58:25:86	bean.PostActivite	Modification par 1	1	POST000021
EX0002878121	2026-02-27	15:00:29:071	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878141	2026-02-27	15:35:39:150	mg.cnaps.utilisateur.CNAPSUser	login	142	142
EX0002878161	2026-02-27	15:47:57:023	mg.cnaps.utilisateur.CNAPSUser	login	1	1
EX0002878181	2026-02-27	17:03:11:72	bean.Like	Insertion par 1	1	LIKE000003
\.
...
LIKE000003	1	POST000021	2026-02-27 16:03:11.707
\.
...
NOTIF000002	1	82	TNOT00001	POST000014	\N	\N	test test a aimé votre publication	publication/publication-fiche.jsp&id=POST000014	1	2026-02-27 13:49:21.742	2026-02-25 23:21:51.789
NOTIF000003	1	82	TNOT00001	POST000014	\N	\N	test test a aimé votre publication	publication/publication-fiche.jsp&id=POST000014	1	2026-02-27 13:49:21.742	2026-02-25 23:21:55.533
NOTIF000001	1	82	TNOT00002	POST000014	COMM000001	\N	test test a commenté votre publication	publication/publication-fiche.jsp&id=POST000014	1	2026-02-27 13:49:27.505	2026-02-25 23:21:44.853
NOT100001	201	203	TNOT00001	POST100001	\N	\N	RANDRIA Tiana a aimé votre publication	/post/POST100001	0	\N	2026-02-10 09:00:00
NOT100002	201	209	TNOT00001	POST100001	\N	\N	MAHEFA Aina a aimé votre publication	/post/POST100001	0	\N	2026-02-10 09:15:00
NOT100003	201	209	TNOT00002	POST100001	COM100001	\N	MAHEFA Aina a commenté votre publication	/post/POST100001	1	\N	2026-02-10 09:15:00
NOT100004	201	211	TNOT00002	POST100001	COM100002	\N	HASINA Miora a commenté votre publication	/post/POST100001	0	\N	2026-02-10 10:00:00
NOT100005	205	202	TNOT00002	POST100005	COM100009	\N	RABE Hery a commenté votre publication	/post/POST100005	1	\N	2026-02-13 11:00:00
NOT100006	205	206	TNOT00002	POST100005	COM100011	\N	RAZAFY Nomena a commenté votre publication	/post/POST100005	0	\N	2026-02-13 12:30:00
NOT100007	209	211	TNOT00007	POST100001	COM100002	\N	HASINA Miora a répondu à votre commentaire	/post/POST100001	0	\N	2026-02-10 10:00:00
NOT100008	202	205	TNOT00007	POST100005	COM100010	\N	ANDRIAMAHEFA Solo a répondu à votre commentaire	/post/POST100005	1	\N	2026-02-13 11:45:00
NOT100009	206	201	TNOT00001	POST100030	\N	\N	RAKOTO Jean a aimé votre publication	/post/POST100030	1	\N	2026-02-14 08:30:00
NOT100010	206	209	TNOT00001	POST100030	\N	\N	MAHEFA Aina a aimé votre publication	/post/POST100030	0	\N	2026-02-14 10:00:00
NOT100011	206	209	TNOT00002	POST100030	COM100023	\N	MAHEFA Aina a commenté votre publication	/post/POST100030	1	\N	2026-02-14 09:00:00
NOT100012	206	213	TNOT00002	POST100030	COM100024	\N	MANOA Nirina a commenté votre publication	/post/POST100030	0	\N	2026-02-14 10:00:00
\.
...
POST000021	Conference IA	Mahamasina	Andoharanofotsy	2026-02-03 08:00:00	2026-02-27 08:00:00	5000	10	10	test@gmail.com	0343439685	https://test.com	\N	\N
POST100029	Conférence IA et Emploi	ITU Andoharanofotsy	Andoharanofotsy, Antananarivo	2026-03-10 09:00:00	2026-03-10 17:00:00	0	200	200	conf@itu.mg	0341000017	https://itu.mg/conf-ia	\N	CATACT001
POST100030	Hackathon ITU 2026	ITU Andoharanofotsy	Andoharanofotsy, Antananarivo	2026-03-15 08:00:00	2026-03-17 18:00:00	15000	100	100	hackathon@itu.mg	0341000006	https://itu.mg/hackathon	\N	CATACT006
POST100031	Atelier Déploiement AWS	Salle B12, ITU	Andoharanofotsy, Antananarivo	2026-03-20 14:00:00	2026-03-20 16:00:00	0	30	30	aws@itu.mg	0341000018	https://itu.mg/atelier-aws	\N	CATACT002
POST100032	Séminaire Blockchain en Afrique	Hôtel Carlton	Anosy, Antananarivo	2026-03-25 09:00:00	2026-03-25 16:00:00	25000	150	150	blockchain@tech.mg	0341000019	https://tech.mg/blockchain	\N	CATACT003
POST100033	Retrouvailles Promotion Soa	La Varangue	Ambohijatovo, Antananarivo	2026-03-08 19:00:00	2026-03-08 23:00:00	30000	50	50	alumni.soa@itu.mg	0341000005	\N	\N	CATACT005
POST100034	Compétition Inter-Universités	ITU Andoharanofotsy	Andoharanofotsy, Antananarivo	2026-04-05 08:00:00	2026-04-05 18:00:00	0	80	80	competition@itu.mg	0341000020	https://itu.mg/competition	\N	CATACT006
POST100035	Sortie Promotion Ravo - Antsirabe	Antsirabe	Antsirabe, Vakinankaratra	2026-03-08 07:00:00	2026-03-08 19:00:00	20000	40	40	ravo@itu.mg	0341000009	\N	\N	CATACT007
\.
...
POST000019	\N	Antananarivo	Base de donnee	CDD	200000.00	1000000.00	MGA	3 ans d'experience en base de donnee	\N	DIPL0001	0	\N	elyance@gmail.com	0343439685		ENT1
POST100011	\N	Antananarivo	Développeur Java/Spring Boot	CDI	800000.00	1500000.00	MGA	2 ans minimum	Java, Spring Boot, PostgreSQL, REST API	DIPL0001	1	2026-03-15	rh@entreprise.mg	0341000001	https://jobs.mg/java-dev	ENT1
POST100012	\N	Antananarivo	Data Analyst	CDI	600000.00	1200000.00	MGA	1 an minimum	Python, SQL, Power BI, Excel avancé	DIPL0001	0	2026-03-20	recrutement@bici.mg	0341000004	https://bici.mg/careers	ENT1
POST100013	\N	Antananarivo	Administrateur Réseau Senior	CDI	1000000.00	2000000.00	MGA	3 ans minimum	Cisco, Linux, Windows Server, Firewall	DIPL0002	0	2026-03-25	rh@bni.mg	0341000008	https://bni.mg/recrutement	ENT3
POST100014	\N	Antananarivo	Développeur Fullstack	CDI	700000.00	1400000.00	MGA	Junior accepté	React, Node.js, PostgreSQL, Git	DIPL0001	1	2026-03-18	jobs@cybersec.mg	0341000005	https://cybersec.mg/apply	\N
POST100015	\N	Antananarivo	Chef de Projet IT	CDI	1200000.00	2500000.00	MGA	4 ans minimum	Gestion de projet, Agile, JIRA	DIPL0002	0	2026-03-30	talent@orange.mg	0341000002	https://orange.mg/jobs	ENT4
POST100016	\N	Antananarivo	DevOps Engineer	CDD	900000.00	1800000.00	MGA	2 ans minimum	Docker, Kubernetes, Jenkins, Terraform	DIPL0001	1	2026-03-22	devops@tech.mg	0341000006	https://tech.mg/devops	\N
POST100017	\N	Antananarivo	UX/UI Designer	CDI	500000.00	1000000.00	MGA	1 an minimum	Figma, Adobe XD, Design System	DIPL0001	1	2026-03-28	design@yas.mg	0341000003	https://yas.mg/careers	ENT2
POST100018	\N	Antananarivo	Tech Lead Mobile	CDI	1000000.00	2200000.00	MGA	3 ans minimum	Flutter, React Native, Firebase	DIPL0002	1	2026-04-01	mobile@tech.mg	0341000007	https://tech.mg/mobile	\N
POST100019	\N	Antananarivo	Consultant ERP SAP	CDI	1500000.00	3000000.00	MGA	5 ans minimum	SAP ABAP, SAP HANA, Gestion de projet	DIPL0002	0	2026-04-10	sap@consulting.mg	0341000001	https://consulting.mg/sap	\N
POST100020	\N	Antananarivo	Ingénieur Machine Learning	CDI	800000.00	1800000.00	MGA	2 ans minimum	TensorFlow, PyTorch, Python, MLOps	DIPL0002	1	2026-04-05	ml@fintech.mg	0341000008	https://fintech.mg/ml-engineer	\N
\.
...
PFIC000008	POST000021	TFIC00001	activite_POST000021_1772191402962_0.png	Capture d’écran du 2025-09-20 20-27-29.png	carriere/activite_POST000021_1772191402962_0.png	358769	image/png	1	\N
\.
...
POST100021	\N	Antananarivo	3 mois	2026-04-01	2026-06-30	200000.00	DIPL0001	HTML, CSS, JavaScript, PHP	1	5	stage@bici.mg	0341000004	https://bici.mg/stages	ENT1
POST100022	\N	Antananarivo	6 mois	2026-03-15	2026-09-15	300000.00	DIPL0002	Python, TensorFlow, Deep Learning	1	2	ia@research.mg	0341000017	https://research.mg/pfe	\N
POST100023	\N	Antananarivo	6 mois	2026-04-01	2026-09-30	250000.00	DIPL0001	Linux, Windows Server, Réseaux	1	3	stage@bni.mg	0341000008	https://bni.mg/stages	ENT3
POST100024	\N	Antananarivo	4 mois	2026-04-15	2026-08-15	280000.00	DIPL0001	Python, pandas, scikit-learn, SQL	1	4	data@orange.mg	0341000018	https://orange.mg/stages	ENT4
POST100025	\N	Antananarivo	3 mois	2026-05-01	2026-07-31	200000.00	DIPL0001	Flutter, Dart, Firebase	0	3	mobile@yas.mg	0341000002	https://yas.mg/stages	ENT2
POST100026	\N	Antananarivo	4 mois	2026-04-01	2026-07-31	250000.00	DIPL0001	Linux, Kali, Wireshark, Pentesting	1	2	sec@cybersec.mg	0341000005	https://cybersec.mg/stage	\N
POST100027	\N	Antananarivo	6 mois	2026-04-01	2026-09-30	350000.00	DIPL0002	AWS, Azure, Terraform, Docker	1	6	cloud@telma.mg	0341000019	https://telma.mg/stages	\N
POST100028	\N	Antananarivo	4 mois	2026-05-01	2026-08-31	220000.00	DIPL0001	Java, Spring Boot, Microservices	1	3	dev@fintech-startup.mg	0341000006	https://fintech-startup.mg/stage	\N
POST000006	\N	\N	3 mois	2026-02-25	2026-05-13	0.00	DIPL0001	\N	0	10	test@gmail.com	0343439685	lien	ENT1
POST000020	\N	\N	3 mois	2026-02-25	\N	200000.00	DIPL0001	\N	0	5				ENT1
\.
...
POST000021	1	\N	TYP00003	STAT00002	VISI00001		0	0	\N	1	0	0	2026-02-27 14:23:22.899	2026-02-27 14:58:25.837731	1
...
POST100002	203	\N	TYP00005	STAT00002	VISI00001	Quelqu'un a des retours sur les bootcamps en Data Science à Madagascar ? Je cherche à me reconvertir après 3 ans en dev web.	0	0	\N	2	2	0	2026-02-10 14:15:00	\N	\N
...
POST000019	122	\N	TYP00002	STAT00002	VISI00001		0	0	\N	0	0	0	2026-02-27 00:51:46.72	\N	\N
POST000020	1	\N	TYP00001	STAT00002	VISI00001	Stage ao amin'ny BICI an'ireo s6 P17.	0	0	\N	0	0	0	2026-02-27 03:16:51.875	\N	\N
POST100007	207	\N	TYP00005	STAT00002	VISI00001	Je viens de publier un article sur Medium à propos de l'IA générative appliquée à l'éducation à Madagascar. Lien dans les commentaires !	0	0	\N	6	1	0	2026-02-15 11:20:00	\N	\N
POST100008	218	\N	TYP00005	STAT00002	VISI00001	Nouveau cours disponible sur la plateforme : Introduction au Cloud Computing avec AWS. Ouvert à tous les étudiants et alumni.	1	0	\N	9	3	0	2026-02-16 08:00:00	\N	\N
POST100009	213	\N	TYP00005	STAT00002	VISI00001	Premier hackathon terminé ! Notre équipe a fini 2ème. L'expérience était incroyable, je recommande à tous de participer.	0	0	\N	7	2	0	2026-02-17 19:30:00	\N	\N
POST100011	201	\N	TYP00002	STAT00002	VISI00001	Notre entreprise recrute un développeur Java/Spring Boot confirmé. Expérience minimum 2 ans. Télétravail partiel possible.	0	0	\N	3	1	0	2026-02-11 09:00:00	\N	\N
POST100012	204	\N	TYP00002	STAT00002	VISI00001	Poste de Data Analyst ouvert chez BICI Madagascar. Maîtrise de Python et SQL requise. Salaire compétitif.	0	0	\N	5	2	0	2026-02-12 10:00:00	\N	\N
POST100013	208	\N	TYP00002	STAT00002	VISI00001	BNI Madagascar cherche un administrateur réseau senior. Certifications Cisco souhaitées.	0	0	\N	2	0	0	2026-02-13 08:30:00	\N	\N
POST100015	202	\N	TYP00002	STAT00002	VISI00001	Orange Madagascar recrute un chef de projet IT. Management d'équipe de 5 personnes. CDI.	0	0	\N	4	1	0	2026-02-15 09:30:00	\N	\N
POST100016	206	\N	TYP00002	STAT00002	VISI00001	Recherche DevOps Engineer pour une mission longue durée. Docker, Kubernetes, CI/CD requis.	0	0	\N	6	2	0	2026-02-16 14:00:00	\N	\N
POST100017	203	\N	TYP00002	STAT00002	VISI00001	Yas Madagascar recrute un UX/UI Designer. Maîtrise de Figma obligatoire. Portfolio à fournir.	0	0	\N	3	1	0	2026-02-17 10:00:00	\N	\N
POST100018	207	\N	TYP00002	STAT00002	VISI00001	Poste de Tech Lead Mobile ouvert. Flutter ou React Native. Équipe dynamique et projets innovants.	0	0	\N	8	2	0	2026-02-18 08:00:00	\N	\N
POST100019	201	\N	TYP00002	STAT00002	VISI00001	Consultant ERP SAP recherché par un cabinet de conseil à Tana. Déplacements ponctuels en province.	0	0	\N	1	0	0	2026-02-19 15:00:00	\N	\N
POST100020	208	\N	TYP00002	STAT00002	VISI00001	Ingénieur Machine Learning chez une fintech malgache. TensorFlow/PyTorch requis. Remote possible.	0	0	\N	5	1	0	2026-02-20 09:00:00	\N	\N
POST100021	217	\N	TYP00001	STAT00002	VISI00001	Stage de 3 mois en développement web chez BICI. Formation assurée, indemnité incluse.	0	0	\N	6	2	0	2026-02-12 08:00:00	\N	\N
POST100003	209	\N	TYP00005	STAT00002	VISI00004	Est-ce que les L3 de cette année ont déjà trouvé leur lieu de stage ? On pourrait s'organiser pour partager nos contacts.	0	0	\N	5	6	0	2026-02-11 09:00:00	\N	\N
POST100022	218	\N	TYP00001	STAT00002	VISI00001	Stage PFE en Intelligence Artificielle. Sujet : détection de fraude par deep learning. Niveau Master requis.	0	0	\N	4	1	0	2026-02-13 10:30:00	\N	\N
POST100023	204	\N	TYP00001	STAT00002	VISI00001	BNI propose un stage de 6 mois en administration système. Les L3 et M1 sont les bienvenus.	0	0	\N	3	1	0	2026-02-14 09:00:00	\N	\N
POST100024	219	\N	TYP00001	STAT00002	VISI00001	Stage en Data Science chez Orange Madagascar. Python, pandas, scikit-learn requis. 4 mois.	0	0	\N	5	2	0	2026-02-15 07:30:00	\N	\N
POST100026	205	\N	TYP00001	STAT00002	VISI00001	Stage en cybersécurité : tests de pénétration et audit. Connaissances Linux et réseaux requises.	0	0	\N	2	0	0	2026-02-17 08:00:00	\N	\N
POST100027	220	\N	TYP00001	STAT00002	VISI00001	Stage cloud computing chez Telma. AWS/Azure, Terraform. Niveau M1 minimum. 6 places disponibles.	0	0	\N	4	1	0	2026-02-18 11:00:00	\N	\N
POST100028	206	\N	TYP00001	STAT00002	VISI00001	Stage backend Java/Spring chez une startup fintech. Microservices, API REST. 4 mois rémunérés.	0	0	\N	3	1	0	2026-02-19 09:30:00	\N	\N
POST100029	217	\N	TYP00003	STAT00002	VISI00001	Grande conférence sur l'IA et son impact sur le marché du travail à Madagascar. Entrée gratuite !	0	0	\N	15	4	0	2026-02-13 07:00:00	\N	\N
POST100031	218	\N	TYP00003	STAT00002	VISI00001	Atelier pratique : déployer une application sur AWS en 2 heures. Ouvert aux étudiants L3 et Master.	0	0	\N	8	2	0	2026-02-16 10:00:00	\N	\N
POST100032	219	\N	TYP00003	STAT00002	VISI00001	Séminaire sur la blockchain et ses applications en Afrique. Intervenants internationaux confirmés.	0	0	\N	6	1	0	2026-02-18 09:00:00	\N	\N
POST100033	205	\N	TYP00003	STAT00002	VISI00001	Rencontre alumni promotion Soa : retrouvailles et partage d'expériences. Resto La Varangue, 19h.	0	0	\N	11	3	0	2026-02-20 12:00:00	\N	\N
POST100034	220	\N	TYP00003	STAT00002	VISI00001	Compétition de programmation inter-universités. Prizes : stages chez Orange et BNI. Inscriptions ouvertes.	0	0	\N	9	2	0	2026-02-22 08:00:00	\N	\N
POST100037	207	\N	TYP00004	STAT00002	VISI00001	Lancement de notre projet de chatbot IA pour l'orientation universitaire. Stack : Python + Langchain + React.	0	0	\N	7	2	0	2026-02-17 11:00:00	\N	\N
POST100038	212	\N	TYP00004	STAT00002	VISI00001	Projet IoT : surveillance de la qualité de l'air à Tana avec des capteurs Arduino. Recherche partenaires techniques.	0	0	\N	5	1	0	2026-02-19 14:00:00	\N	\N
POST100039	215	\N	TYP00004	STAT00002	VISI00001	Application mobile e-santé pour le suivi des patients en zone rurale. Flutter + Firebase. Equipe de 4, cherche un designer.	0	0	\N	6	2	0	2026-02-21 09:00:00	\N	\N
POST100040	214	\N	TYP00004	STAT00002	VISI00001	Plateforme de covoiturage pour étudiants malgaches. En cours de développement, beta prévue en mars.	0	0	\N	4	1	0	2026-02-23 16:00:00	\N	\N
POST100006	210	\N	TYP00005	STAT00002	VISI00004	Comment vous gérez le stress des examens ? J'ai du mal à jongler entre les projets et les partiels cette année.	0	0	\N	4	4	0	2026-02-14 16:00:00	\N	\N
POST100001	201	\N	TYP00005	STAT00002	VISI00001	Bonjour à tous les alumni ! Quelles sont les technologies que vous utilisez le plus en 2026 ? Personnellement, je suis passé à Rust pour le backend et c'est un vrai game changer.	0	0	\N	6	4	0	2026-02-10 08:30:00	\N	\N
POST100005	205	\N	TYP00005	STAT00002	VISI00001	Retour d'expérience : après 5 ans chez Orange, je viens de lancer ma propre boîte spécialisée en cybersécurité. AMA !	0	0	\N	24	8	0	2026-02-13 10:30:00	\N	\N
POST100010	206	\N	TYP00005	STAT00002	VISI00001	Qui serait intéressé par un meetup mensuel des alumni ITU à Tana ? On pourrait alterner présentations techniques et networking.	0	0	\N	20	10	0	2026-02-18 13:00:00	\N	\N
POST100030	206	\N	TYP00003	STAT00002	VISI00001	Hackathon ITU 2026 : 48h pour innover ! Thème : solutions numériques pour l'éducation. Inscrivez-vous vite.	1	0	\N	38	12	0	2026-02-14 08:00:00	\N	\N
POST100004	217	\N	TYP00005	STAT00002	VISI00001	Rappel : les inscriptions pour le concours national de programmation sont ouvertes jusqu'au 15 mars. N'hésitez pas à former vos équipes !	1	0	\N	12	4	0	2026-02-12 07:45:00	\N	\N
POST100014	205	\N	TYP00002	STAT00002	VISI00001	Startup en cybersécurité recherche développeur fullstack. Stack : React + Node.js + PostgreSQL.	0	0	\N	10	6	0	2026-02-14 11:00:00	\N	\N
POST100036	211	\N	TYP00004	STAT00002	VISI00001	Projet open source : application de gestion scolaire pour les écoles rurales de Madagascar. Contributeurs bienvenus !	0	0	\N	12	6	0	2026-02-15 10:00:00	\N	\N
POST100025	202	\N	TYP00001	STAT00002	VISI00001	Yas Madagascar offre un stage en développement mobile Flutter. Durée 3 mois, possibilité d'embauche.	0	0	\N	11	3	0	2026-02-16 10:00:00	\N	\N
POST100035	209	\N	TYP00003	STAT00002	VISI00004	Sortie promotion Ravo : journée détente à Antsirabe le 8 mars. Participation : 20 000 Ar. Confirmez avant le 1er mars.	0	0	\N	16	5	0	2026-02-23 14:00:00	\N	\N
\.
...
USRM_CAR_2	*	MENDYNCARRIERE-2-2	\N	\N	\N	0
USRM_CAR_3	*	MENDYNCARRIERE-3-1	\N	\N	\N	0
USRM_CAR_4	*	MENDYNCARRIERE-3-2	\N	\N	\N	0
USRM_CAR_5	*	MENDYNCARRIERE-4-1	\N	\N	\N	0
USRM_CAR_6	*	MENDYNCARRIERE-4-2	\N	\N	\N	0
...
201	rakoto.jean	alumni2026	RAKOTO	Analakely	0341000001	alumni	0	Jean	2001	jean.rakoto@gmail.com		TU0000001	P5	2026-02-27 15:19:10.625018
202	rabe.hery	alumni2026	RABE	Ankorondrano	0341000002	alumni	0	Hery	2002	hery.rabe@gmail.com		TU0000001	P7	2026-02-27 15:19:10.625018
203	randria.tiana	alumni2026	RANDRIA	Ivandry	0341000003	alumni	0	Tiana	2003	tiana.randria@gmail.com		TU0000001	P3	2026-02-27 15:19:10.625018
204	ravelo.haja	alumni2026	RAVELO	Ambatobe	0341000004	alumni	0	Haja	2004	haja.ravelo@gmail.com		TU0000001	P10	2026-02-27 15:19:10.625018
205	andria.solo	alumni2026	ANDRIAMAHEFA	Ambohijatovo	0341000005	alumni	0	Solo	2005	solo.andria@gmail.com		TU0000001	P1	2026-02-27 15:19:10.625018
206	razafy.nomena	alumni2026	RAZAFY	Mahamasina	0341000006	alumni	0	Nomena	2006	nomena.razafy@gmail.com		TU0000001	P12	2026-02-27 15:19:10.625018
207	rahari.vonjy	alumni2026	RAHARISON	Ampefiloha	0341000007	alumni	0	Vonjy	2007	vonjy.rahari@gmail.com		TU0000001	D2	2026-02-27 15:19:10.625018
208	ratsima.feno	alumni2026	RATSIMA	Antanimena	0341000008	alumni	0	Feno	2008	feno.ratsima@gmail.com		TU0000001	D4	2026-02-27 15:19:10.625018
209	mahefa.aina	etudiant2026	MAHEFA	Ankatso	0341000009	etudiant	0	Aina	3001	aina.mahefa@itu.mg		TU0000002	P17	2026-02-27 15:19:10.625018
210	fitia.lalaina	etudiant2026	FITIA	Ambohipo	0341000010	etudiant	0	Lalaina	3002	lalaina.fitia@itu.mg		TU0000002	P17	2026-02-27 15:19:10.625018
211	hasina.miora	etudiant2026	HASINA	Andravoahangy	0341000011	etudiant	0	Miora	3003	miora.hasina@itu.mg		TU0000002	P16	2026-02-27 15:19:10.625018
212	tsiry.rado	etudiant2026	TSIRINIAINA	Amboditsiry	0341000012	etudiant	0	Rado	3004	rado.tsiry@itu.mg		TU0000002	P16	2026-02-27 15:19:10.625018
213	manoa.nirina	etudiant2026	MANOA	Ankadifotsy	0341000013	etudiant	0	Nirina	3005	nirina.manoa@itu.mg		TU0000002	P15	2026-02-27 15:19:10.625018
214	faniry.ando	etudiant2026	FANIRY	Behoririka	0341000014	etudiant	0	Ando	3006	ando.faniry@itu.mg		TU0000002	P15	2026-02-27 15:19:10.625018
215	mamitiana.lova	etudiant2026	MAMITIANA	Anosibe	0341000015	etudiant	0	Lova	3007	lova.mamitiana@itu.mg		TU0000002	D5	2026-02-27 15:19:10.625018
216	iary.tahina	etudiant2026	IARY	Isotry	0341000016	etudiant	0	Tahina	3008	tahina.iary@itu.mg		TU0000002	D5	2026-02-27 15:19:10.625018
217	ramana.bodo	enseignant2026	RAMANANTOANINA	Ivato	0341000017	enseignant	0	Bodo		bodo.ramana@itu.mg		TU0000003	\N	2026-02-27 15:19:10.625018
218	rajao.lanto	enseignant2026	RAJAONARISON	Ambohidratrimo	0341000018	enseignant	0	Lanto		lanto.rajao@itu.mg		TU0000003	\N	2026-02-27 15:19:10.625018
219	rako.mamy	enseignant2026	RAKOTOMALALA	Tanjombato	0341000019	enseignant	0	Mamy		mamy.rako@itu.mg		TU0000003	\N	2026-02-27 15:19:10.625018
220	rava.seth	enseignant2026	RAVALISON	Ambanidia	0341000020	enseignant	0	Seth		seth.rava@itu.mg		TU0000003	\N	2026-02-27 15:19:10.625018
1	admin	firns	Admin		0343439685	admin	0	Super		admin@alumni-itu.mg	profile_1772195624933.jpg	TU0000001	P1	2026-02-23 10:25:54.786234
142	Elyance	jqyfshj	Elyance	Andoharanofotsy	0340965066	alumni	0	Fenohasina	586	elyance@gmail.com	profile_1772195764041.jpg	TU0000001	P1	2026-02-26 12:51:20.592387
\.
...
UINT000006	1	TOP00013	2026-02-27 15:31:26.051
UINT000007	1	TOP00011	2026-02-27 15:31:26.053
UINT000008	1	TOP00022	2026-02-27 15:31:26.053
UINT000009	1	TOP00023	2026-02-27 15:31:26.054
UINT000010	1	TOP00012	2026-02-27 15:31:26.054
UINT000011	1	TOP00002	2026-02-27 15:31:26.055
UINT000012	1	TOP00001	2026-02-27 15:31:26.055
UINT000013	1	TOP00005	2026-02-27 15:31:26.056
UINT000014	1	TOP00024	2026-02-27 15:31:26.056
UINT000015	1	TOP00010	2026-02-27 15:31:26.056
\.
...
SELECT pg_catalog.setval('public.seq_likes', 3, true);
...
SELECT pg_catalog.setval('public.seq_post_fichiers', 8, true);
...
SELECT pg_catalog.setval('public.seq_posts', 21, true);
...
SELECT pg_catalog.setval('public.seq_utilisateur_interets', 15, true);
...
SELECT pg_catalog.setval('public.seqhistorique', 2878200, true);
...
SELECT pg_catalog.setval('public.utilisateur_refuser_seq', 220, true);
...
\unrestrict HzXUdTTdtwMzyS1ohJNswn1cmo9FqimZGPBGXwlynIIh34XYa2SncAYTcET93A9
