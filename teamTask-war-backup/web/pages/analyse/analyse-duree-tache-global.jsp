...
<%
    try {
        ...
        String[] pourcentage = {};
        String somDefaut[] = {"dureeTheorique","dureeReelle"};
        ...
        pr.setApres("analyse/analyse-duree-tache-global.jsp");
        ...
        pr.creerObjetPageCroise(colGrCol, pr.getLien() + "?but=analyse/analyse-duree-tache-global.jsp");
%>
<script>
...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Analyse de dur&eacute;e des t&acirc;ches assign&eacute;es et accomplies par ressource</h1>
    </section>
    <section class="content">
        ...
        <div style="margin-bottom:8px; font-size:14px; font-style:italic;">
            Ligne 1 = Dur&eacute;e Th&eacute;orique &nbsp;&nbsp;|&nbsp;&nbsp; Ligne 2 = Dur&eacute;e R&eacute;elle
        </div>
