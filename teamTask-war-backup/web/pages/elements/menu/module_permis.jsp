                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                ...
                                <ul class="">
                                    <li><a href="<%=lien%>?but=inscription/dossierInscription-liste.jsp" class="menu-niveau-3">Liste permis</a></li>
                                    <li><a href="<%=lien%>?but=inscription/inscription-import.jsp" class="menu-niveau-3">Import permis</a></li>
                                    <li><a href="<%=lien%>?but=inscription/dossierInscription-liste.jsp&etat=INSCRIPTION_CREE" class="menu-niveau-3">Liquidation permis</a></li>
                            ...
                            <li>
                                <a href="" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Examinateur</a>
                                <ul class="">
                                    <li><a href="<%=lien%>?but=examinateur/examinateur-liste.jsp" class="menu-niveau-3">Liste examinateur</a></li>
                                    <li><a href="<%=lien%>?but=redevance/redevance-liste.jsp&typeEtat=sortie" class="menu-niveau-3">Liste redevance examinateur</a></li>
                                    <li><a href="<%=lien%>?but=admission/etat-salaire-examinateur.jsp&typeEtat=sortie" class="menu-niveau-3">Etat de salaire</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Examen</a>
                                <ul class="">
                                    <li><a href="<%=lien%>?but=examen/examen-liste.jsp" class="menu-niveau-3">Liste examen</a></li>
                                    <li><a href="<%=lien%>?but=enregistrement/enregistrement.jsp" class="menu-niveau-3">Générer examen</a></li>
                                    <li><a href="<%=lien%>?but=examen/planification-examen-liste.jsp" class="menu-niveau-3">Planifier examen</a></li>
                                    <li><a href="<%=lien%>?but=examen/planning-liste.jsp" class="menu-niveau-3">Planning examen</a></li>
                                    <li><a href="<%=lien%>?but=enregistrement/jour-ouvrable.jsp" class="menu-niveau-3">Gestion des jours ouvrables</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="" class="menu-niveau-2"><i class="fa fa-folder-open"></i>Resultat</a>
                                <ul class="">
                                    <li><a href="<%=lien%>?but=bordereau_envoi/bordereau-envoi-liste.jsp" class="menu-niveau-3"><i class="fa fa-folder-open"></i>Bordereau d'envoi</a></li>
                                    <li><a href="<%=lien%>?but=admission/saisie-resultat-par-examinateur.jsp&typeEtat=sortie" class="menu-niveau-3">Saisie admission examen</a></li>
                                    <li><a href="<%=lien%>?but=admission/liste-admission.jsp" class="menu-niveau-3">Liste admission examen</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
