                ...
                <div id="menu-body">
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li><a href="<%=lien%>?but=amende/amende-liste.jsp&etat=amende_non_creer" class="menu-niveau-2">Liquidation amende</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="   ">
                            <li><a href="<%=lien%>?but=autre/autre-recette-liste.jsp&saisie=autre/autre-recette-saisie.jsp" class="menu-niveau-2">Liste Autres activités</a></li>
                            <li><a href="<%=lien%>?but=autre/autre-recette-saisie.jsp" class="menu-niveau-2">Saisie Autres activités</a></li>
                            <li><a href="<%=lien%>?but=autre/autre-recette-liste.jsp&saisie=autre/autre-recette-saisie.jsp" class="menu-niveau-2">Liquidation Autres activités</a></li>
                        </ul>
                    </li>
