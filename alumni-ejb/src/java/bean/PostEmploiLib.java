...
/**
 * Vue enrichie pour les offres d'emploi.
 * Utilisee par PageRecherche et PageConsulte (lecture seule).
 * Jointure : post_emploi + posts + utilisateur_acade + statut_publication + visibilite_publication
 */
public class PostEmploiLib extends PostEmploi {

    // Champs additionnels venant des JOINs dans v_post_emploi_cpl
    ...
    public PostEmploiLib() {
        super();
        super.setNomTable("v_post_emploi_cpl");
    }
