...
/**
 * Bean pour v_signalements_publications - signalements de publications avec jointures.
 */
public class SignalementPublication extends ClassMAPTable {
    ...
    // Champs de jointure - publication
    private String publication_contenu;
    private int publication_supprime;
    private Timestamp publication_date;
    private String publication_auteur;
    
    // Champs de jointure - modérateur
    private String moderateur_nom;

    public SignalementPublication() {
        super.setNomTable("v_signalements_publications");
    }
    ...
    public String getPublication_contenu() { return publication_contenu; }
    public void setPublication_contenu(String publication_contenu) { this.publication_contenu = publication_contenu; }

    public int getPublication_supprime() { return publication_supprime; }
    public void setPublication_supprime(int publication_supprime) { this.publication_supprime = publication_supprime; }

    public Timestamp getPublication_date() { return publication_date; }
    public void setPublication_date(Timestamp publication_date) { this.publication_date = publication_date; }

    public String getPublication_auteur() { return publication_auteur; }
    public void setPublication_auteur(String publication_auteur) { this.publication_auteur = publication_auteur; }
