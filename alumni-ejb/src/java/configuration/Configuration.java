...
public class Configuration extends ClassMAPTable{
    ...
    public String getValmin() {
        return UtilitaireAcade.champNull(valmin);
    }
    ...
    public String getValmax() {
        return UtilitaireAcade.champNull(valmax);
    }
    ...
    public String getDesce() {
        return UtilitaireAcade.champNull(desce);
    }
    ...
    public String getRemarque() {
        return UtilitaireAcade.champNull(remarque);
    }
    ...
    public String getTypeconfig() {
        return UtilitaireAcade.champNull(typeconfig);
    }
